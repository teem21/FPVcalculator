...
const translations = {
  ru: {
    ...
    tapExpand: 'нажмите чтобы развернуть',
    spec_version: 'версия', spec_battery: 'аккум', spec_esc: 'esc', spec_fc: 'fc',
    spec_camera: 'камера', spec_vtx: 'vtx', spec_rx: 'rx', spec_tx: 'tx',
    spec_fib_gnd: 'станция', spec_fib_len: 'оптика км', spec_ai: 'ai',
  ...
  en: {
    ...
    spec_version: 'version', spec_battery: 'battery', spec_esc: 'esc', spec_fc: 'fc',
    spec_camera: 'camera', spec_vtx: 'vtx', spec_rx: 'rx', spec_tx: 'tx',
    spec_fib_gnd: 'gnd station', spec_fib_len: 'fiber km', spec_ai: 'ai',
  ...
  zh: {
    ...
    tapExpand: '点击展开',
    spec_version: '版本', spec_battery: '电池', spec_esc: '电调', spec_fc: '飞控',
    spec_camera: '摄像', spec_vtx: '图传', spec_rx: '接收', spec_tx: '发射',
    spec_fib_gnd: '地面站', spec_fib_len: '光纤km', spec_ai: 'AI',
